const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PHANTOM_FORCE] = _("Ghost Force"),
    [MOVE_TRICK_OR_TREAT] = _("Halloween"),
    [MOVE_NOBLE_ROAR] = _("Noble Roar"),
    [MOVE_ION_DELUGE] = _("Ion Deluge"),
    [MOVE_PARABOLIC_CHARGE] = _("Parabola Chg"),
    [MOVE_FOREST_S_CURSE] = _("Forest Curse"),
    ...
    [MOVE_CRAFTY_SHIELD] = _("Craft Shield"),
    [MOVE_FLOWER_SHIELD] = _("Flora Shield"),
    ...
    [MOVE_EERIE_IMPULSE] = _("Eerie Wave"),
    ...
    [MOVE_LAND_S_WRATH] = _("Land's Wrath"),
    [MOVE_LIGHT_OF_RUIN] = _("Ruin Light"),
    [MOVE_ORIGIN_PULSE] = _("Origin Pulse"),
    [MOVE_PRECIPICE_BLADES] = _("Cliff's Blade"),
