...
const u32 gTrainerFrontPic_PC[] = INCBIN_U32("graphics/trainers/front_pics/pc.4bpp.lz");
const u32 gTrainerPalette_PC[] = INCBIN_U32("graphics/trainers/front_pics/pc.gbapal.lz");
