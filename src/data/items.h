...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId. TOFOLD
...
// Story Key Items TOFOLD
    ...
    [UNIQUE_ITEM_PHOTO_1] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_PhotoPic,
