...
{
    [APPRENTICE_FUNC_GAVE_LVLMODE]        = Script_GivenApprenticeLvlMode_apprentice,
    [APPRENTICE_FUNC_SET_LVLMODE]         = Script_SetApprenticeLvlMode_apprentice,
    [APPRENTICE_FUNC_SET_ID]              = Script_SetApprenticeId_apprentice,
    [APPRENTICE_FUNC_SHUFFLE_SPECIES]     = ShuffleApprenticeSpecies_apprentice,
    [APPRENTICE_FUNC_RANDOMIZE_QUESTIONS] = Script_SetRandomQuestionData_apprentice,
    [APPRENTICE_FUNC_ANSWERED_QUESTION]   = IncrementQuestionsAnswered_apprentice,
    [APPRENTICE_FUNC_IS_FINAL_QUESTION]   = IsFinalQuestion_apprentice,
    [APPRENTICE_FUNC_MENU]                = Script_CreateApprenticeMenu_apprentice,
    [APPRENTICE_FUNC_PRINT_MSG]           = Script_PrintApprenticeMessage_apprentice,
    [APPRENTICE_FUNC_RESET]               = Script_ResetPlayerApprentice_apprentice,
    [APPRENTICE_FUNC_CHECK_GONE]          = GetShouldCheckApprenticeGone_apprentice,
    [APPRENTICE_FUNC_GET_QUESTION]        = ApprenticeGetQuestion_apprentice,
    [APPRENTICE_FUNC_GET_NUM_PARTY_MONS]  = GetNumApprenticePartyMonsAssigned_apprentice,
    [APPRENTICE_FUNC_SET_PARTY_MON]       = SetApprenticePartyMon_apprentice,
    [APPRENTICE_FUNC_INIT_QUESTION_DATA]  = InitQuestionData_apprentice,
    [APPRENTICE_FUNC_FREE_QUESTION_DATA]  = FreeQuestionData_apprentice,
    [APPRENTICE_FUNC_BUFFER_STRING]       = ApprenticeBufferString_apprentice,
    [APPRENTICE_FUNC_SET_MOVE]            = SetApprenticeMonMove_apprentice,
    [APPRENTICE_FUNC_SET_LEAD_MON]        = SetLeadApprenticeMon_apprentice,
    [APPRENTICE_FUNC_OPEN_BAG]            = Script_ApprenticeOpenBagMenu_apprentice,
    [APPRENTICE_FUNC_TRY_SET_HELD_ITEM]   = TrySetApprenticeHeldItem_apprentice,
    [APPRENTICE_FUNC_SAVE]                = SaveApprentice_apprentice,
    [APPRENTICE_FUNC_SET_GFX_SAVED]       = SetSavedApprenticeTrainerGfxId_apprentice,
    [APPRENTICE_FUNC_SET_GFX]             = SetPlayerApprenticeTrainerGfxId_apprentice,
    [APPRENTICE_FUNC_SHOULD_LEAVE]        = GetShouldApprenticeLeave_apprentice,
    [APPRENTICE_FUNC_SHIFT_SAVED]         = ShiftSavedApprentices_apprentice,
};
