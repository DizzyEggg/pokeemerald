...
const u8 gText_DadsAdvice[] = _("This item cannot\nbe used right now!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnDemotedToLvVar2[] = _("{STR_VAR_1} was demoted to\nLv. {STR_VAR_2}.");
...
const u8 gText_XNatureMetUnknown[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nmet at {COLOR}{05}?{COLOR}{01}.");
