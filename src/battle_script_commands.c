...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    { ITEM_SITRUS_BERRY,    {  40,  40,  40,  40,  40,  40,  40,  40,  40,  40, } },
    { ITEM_LUM_BERRY,       {  20,  20,  20,  20,  20,  20,  20,  20,  20,  20, } },
    { ITEM_RARE_CANDY,      {  20,  20,  20,  20,  20,  20,  20,  20,  20,  20, } },
    { ITEM_LEFTOVERS,       {  10,  10,  10,  10,  10,  10,  10,  10,  10,  10, } },
    { ITEM_EVIOLITE,        {  10,  10,  10,  10,  10,  10,  10,  10,  10,  10, } },
    { ITEM_BIG_MUSHROOM,    {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_SUPER_REPEL,     {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_FULL_HEAL,       {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_REVIVE,          {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_HYPER_POTION,    {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_ETHER,           {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_REPEL,       {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MOON_STONE,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_SUN_STONE,       {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_RARE_CANDY,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_NUGGET,          {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_POTION,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_ETHER,       {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_PP_UP,           {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BIG_NUGGET,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_DESTINY_KNOT,    {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_LEFTOVERS,       {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MENTAL_HERB,     {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_POWER_HERB,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_WHITE_HERB,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BALM_MUSHROOM,   {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_REVIVE,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_ELIXIR,          {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_ELIXIR,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BOTTLE_CAP,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
};
