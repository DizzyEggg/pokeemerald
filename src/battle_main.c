...
static void TryDoEventsBeforeFirstTurn(void)
{
    ...
    case FIRST_TURN_EVENTS_TOTEM_BOOST:
        ...
        if (FlagGet(FLAG_BATTLE_START_LEECH_SEED))
        {
            ...
            gBattleMons[GetBattlerAtPosition(B_POSITION_PLAYER_LEFT)].volatiles.leechSeed = oppBattler + 1;
            gBattleMons[GetBattlerAtPosition(B_POSITION_PLAYER_RIGHT)].volatiles.leechSeed = oppBattler + 1;
        }
