...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_TIMETODYNAMAX]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s "),
    [STRINGID_TIMETOGIGANTAMAX]                     = COMPOUND_STRING("Time to Gigantamax!"),
    [STRINGID_LEVELDOWN]                            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was demoted\nby {B_BUFF1} {B_BUFF2}!"),
    [STRINGID_WORD_LEVEL]                            = COMPOUND_STRING("level"),
    [STRINGID_WORD_LEVELS]                            = COMPOUND_STRING("levels"),
