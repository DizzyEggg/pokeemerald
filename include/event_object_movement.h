...
void MovementType_InPlayerDirection(struct Sprite *sprite);
void MovementType_InPlayerDirectionFaster1(struct Sprite *sprite);
void MovementType_InPlayerDirectionFaster2(struct Sprite *sprite);
void MovementType_InPlayerDirectionFaster3(struct Sprite *sprite);
void MovementType_InPlayerDirectionFaster4(struct Sprite *sprite);
void MovementType_InPlayerDirectionFaster5(struct Sprite *sprite);
...
u8 MovementType_InPlayerDirection_Step0(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirectionFaster1_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirectionFaster2_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirectionFaster3_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirectionFaster4_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirectionFaster5_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step3(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step4(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step5(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_InPlayerDirection_Step6(struct ObjectEvent *objectEvent, struct Sprite *sprite);
