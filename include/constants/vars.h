...
#define VAR_BATTLE_LVL_UP                                0x40A8 // Was unused - now defines how many levels the pokemon's level goes up in a pokemon battle. If 0 level goes up by 1.
...
#define VAR_MANSION_COMPLETE_RUNS                        0x40F7 // Unused Var
#define VAR_MANSION_DEATHS                               0x40F8 // Unused Var
#define VAR_FLOOR2_ENTRANCE_STATE                        0x40F9 // For randomizing floor2 opponents
#define VAR_FLOOR3_ENTRANCE_STATE                        0x40FA // For randomizing floor3 opponents
