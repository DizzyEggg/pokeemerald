...
#define MOVE_EXPANDING_FORCE          (MOVES_COUNT_GEN7 + 35)
#define MOVE_STEEL_ROLLER             (MOVES_COUNT_GEN7 + 36)
#define MOVE_SCALE_SHOT               (MOVES_COUNT_GEN7 + 37)
#define MOVE_METEOR_BEAM              (MOVES_COUNT_GEN7 + 38)
#define MOVE_SHELL_SIDE_ARM           (MOVES_COUNT_GEN7 + 39)
#define MOVE_MISTY_EXPLOSION          (MOVES_COUNT_GEN7 + 40)
#define MOVE_GRASSY_GLIDE             (MOVES_COUNT_GEN7 + 41)
#define MOVE_RISING_VOLTAGE           (MOVES_COUNT_GEN7 + 42)
#define MOVE_TERRAIN_PULSE            (MOVES_COUNT_GEN7 + 43)
#define MOVE_SKITTER_SMACK            (MOVES_COUNT_GEN7 + 44)
#define MOVE_BURNING_JEALOUSY         (MOVES_COUNT_GEN7 + 45)
#define MOVE_LASH_OUT                 (MOVES_COUNT_GEN7 + 46)
#define MOVE_POLTERGEIST              (MOVES_COUNT_GEN7 + 47)
#define MOVE_CORROSIVE_GAS            (MOVES_COUNT_GEN7 + 48)
#define MOVE_COACHING                 (MOVES_COUNT_GEN7 + 49)
#define MOVE_FLIP_TURN                (MOVES_COUNT_GEN7 + 50)
#define MOVE_TRIPLE_AXEL              (MOVES_COUNT_GEN7 + 51)
#define MOVE_DUAL_WINGBEAT            (MOVES_COUNT_GEN7 + 52)
#define MOVE_SCORCHING_SANDS          (MOVES_COUNT_GEN7 + 53)
#define MOVE_JUNGLE_HEALING           (MOVES_COUNT_GEN7 + 54)
#define MOVE_WICKED_BLOW              (MOVES_COUNT_GEN7 + 55)
#define MOVE_SURGING_STRIKES          (MOVES_COUNT_GEN7 + 56)

#define MOVES_COUNT_GEN8              (MOVES_COUNT_GEN7 + 57)
