...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            IS_DEBUG_BUILD               // Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default.
...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               IS_DEBUG_BUILD   // If set to TRUE, enables a debug menu to use in battles by pressing the Select button.
